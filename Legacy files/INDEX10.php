...
<head>
  ...
  <meta name="An ecommerce concept site" content="">
  <meta name="kg15abr" content="">

  <title>Index - Assignment 2 - eCommerce concept</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <h1 class="my-4"><br/>KarGadgets</h1>
...
if ($result->num_rows > 0) 
{
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
    {
        ...
        echo "<img class=\"card-img-top\" src=\"$thisImage\" /><br/><h3>$thisCaption</h3><p></p><br/>£$thisPrice";
        echo '</a>';
